  ...
  return (
    <div className="w-[500px] h-[600px] flex ml-15  rounded-lg border border-[#178080] flex-col shadow-lg transition-shadow hover:shadow-2xl bg-white">
      ...
      <div className="flex flex-col">
        <p className="p-3 font-semibold text-[#4d4f52]">{alvo}</p>
        <p className="p-4 text-[20px] text-[#4d4f52]">{descricao}</p>
      </div>
      <div className="flex flex-col"></div>
      <p className="p-3 font-bold text-[20px]">Instruções:</p>
        <p className="p-3 text-[18px] font-semibold">{p1}</p>
        <p className="p-3 text-[18px] font-semibold ">{p2}</p>
        <p className="p-3 text-[18px] font-semibold ">{p3}</p>
        <p className="p-3 text-[18px] font-semibold">{p4}</p>
