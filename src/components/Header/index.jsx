    ...
    return(
        <div className="w-full h-[70px] bg-[#178080] flex items-center justify-between px-10">
            ...
            <nav className="flex space-x-6 font-semibold">
                ...
                <a href="/imc" className="text-white hover:text-[#FF7F6A]">IMC</a>
                <a href="/exercise" className="text-white hover:text-[#FF7F6A]">Exercícios</a>
                <a href="/nutrition" className="text-white hover:text-[#FF7F6A]">Nutrição</a>
                <a href="/location" className="text-white hover:text-[#FF7F6A]">Localização</a>
            </nav>
        </div>
